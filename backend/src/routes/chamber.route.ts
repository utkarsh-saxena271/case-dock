...
import { createChamberController, deleteChamberController, discoverChambersController, getChamberByIdController, getMyChambersController, updateChamberController } from '../controllers/chamber.controller.js';
